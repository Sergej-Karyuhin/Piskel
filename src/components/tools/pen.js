export default class Pen {
  ...
  init() {
    ...
    this.canvasBackground.addEventListener('contextmenu', Pen.canselDefaultRightClick.bind(this));

    // Custom cursor
    const canvasContainer = document.querySelector('#canvas__wrapper');
    canvasContainer.style.cursor = 'url(\'https://www.piskelapp.com/p/img/cursors/pen.png\') 0 16, auto';
  }
}
