export default class Eraser {
  ...
  init() {
    ...
    this.canvasBackground.addEventListener('contextmenu', Eraser.canselDefaultRightClick.bind(this));

    // Custom cursor
    const canvasContainer = document.querySelector('#canvas__wrapper');
    canvasContainer.style.cursor = 'url(\'https://www.piskelapp.com/p/img/cursors/eraser.png\') 0 16, auto';
  }
}
