...
export default class Stroke {
  ...
  init() {
    ...
    this.canvasBackground.addEventListener('contextmenu', Stroke.canselDefaultRightClick.bind(this));

    // Custom cursor
    const canvasContainer = document.querySelector('#canvas__wrapper');
    canvasContainer.style.cursor = 'url(\'https://www.piskelapp.com/p/img/cursors/stroke.png\') 0 16, auto';
  }
}
